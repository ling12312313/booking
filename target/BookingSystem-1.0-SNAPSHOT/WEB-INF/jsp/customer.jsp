...
<div id="wrapper">
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown"><a class="dropdown-toggle"
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="/customer/information"><i class="fa fa-user fa-fw"></i> 个人信息</a></li>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <%--                            class="fa fa-dashboard fa-fw"></i> 我的订单</a></li>--%>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
        </div>
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">机票信息列表</div>
                    <!-- /.panel-heading -->
                    <table class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${page.rows}" var="row">
                            <tr>
                                ...
                                <td>${row.end_place}</td>
                                <td>${row.economy_tickect}</td>
                                <td>${row.bussiness_tickect}</td>
                                <td>${row.price}</td>
                                <td>${row.discount}%</td>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="edit_customer_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="datetime" class="form-control" id="takeoff_time" name="takeoff_time">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="economy_tickect" class="col-sm-2 control-label">经济舱票</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="economy_tickect" placeholder="经济舱票数"
                                   name="economy_tickect">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bussiness_tickect" class="col-sm-2 control-label">商务舱票</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="bussiness_tickect" placeholder="商务舱票数"
                                   name="bussiness_tickect">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="price" class="col-sm-2 control-label">经济票价</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="price" placeholder="经济舱票价" name="price">
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="customerInsertDialog" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="insert_customer_form">
                    <div class="form-group">
                        <label for="insert_fly_name" class="col-sm-2 control-label">航班号</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="insert_fly_name" placeholder="航班号"
                                   name="fly_name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="insert_type" class="col-sm-2 control-label">机型</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="insert_type" placeholder="机型" name="type">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="insert_takeoff_time" class="col-sm-2 control-label">起飞时间</label>
                        <div class="col-sm-10">
                            <input type="datetime-local" class="form-control" id="insert_takeoff_time"
                                   placeholder="起飞时间" name="takeoff_time">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="insert_land_time" class="col-sm-2 control-label">降落时间</label>
                        <div class="col-sm-10">
                            <input type="datetime-local" class="form-control" id="insert_land_time" placeholder="降落时间"
                                   name="land_time">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="insert_start_place" class="col-sm-2 control-label">出发地</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="insert_start_place" placeholder="出发地"
                                   name="start_place">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="insert_end_place" class="col-sm-2 control-label">目的地</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="insert_end_place" placeholder="目的地"
                                   name="end_place">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="insert_economy_tickect" class="col-sm-2 control-label">经济舱票</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="insert_economy_tickect" placeholder="经济舱票数"
                                   name="economy_tickect">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="insert_bussiness_tickect" class="col-sm-2 control-label">商务舱票</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="insert_bussiness_tickect" placeholder="商务舱票数"
                                   name="bussiness_tickect">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="insert_price" class="col-sm-2 control-label">经济票价</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="insert_price" placeholder="经济舱票价" name="price">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="insert_discount" class="col-sm-2 control-label">折扣</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="insert_discount" placeholder="折扣"
                                   name="discount">
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function editCustomer(id) {
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#economy_tickect").val(data.economy_tickect);
                $("#bussiness_tickect").val(data.bussiness_tickect);
    ...
    function insertCustomer() {
        $.post("<%=basePath%>customer/insert.action", $("#insert_customer_form").serialize(), function (data) {
            alert("航班信息插入成功！");
