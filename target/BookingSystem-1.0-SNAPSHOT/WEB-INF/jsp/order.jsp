        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="/flight/list" class="active"><i
                            class="fa fa-edit fa-fw"></i> 订票</a></li>
                    <li><a href="/order/list"><i
    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" action="${pageContext.request.contextPath }/flight/list.action" method="post">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-danger btn-xs" data-toggle="modal"
                                       data-target="#customerEditDialog" onclick="editCustomer(${row.id})">订票</a>
                    ...
                    <div class="col-md-12 text-right">
                        <itcast:page url="${pageContext.request.contextPath }/flight/list.action"/>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">航班订单信息</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="edit_order_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="tickect_type" name="tickect_type">
                    ...
                    <div class="form-group">
                        <label for="price" class="col-sm-2 control-label">原票价</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="price" placeholder="原票价" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="discount" class="col-sm-2 control-label">终价</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="end_price" placeholder="终价" name="price"
                                   readonly="readonly">
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="insertOrder()">确认</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function editCustomer(id) {
        $.ajax({
            ...
            success: function (result) {
                ...
                economy = data.economy_tickect;
                bussiness = data.bussiness_tickect;
                $("#num").val(economy);
                var p = +$("#price").val();
                var d = +$("#discount").val();

                var a = $("#end_price").val(p * (1 - d / 100));

                $("#tickect_type").change(function () {

                    var type = $("#tickect_type").val();
                    if (type == "商务舱") {
                        $("#price").val(p + 1000);
                        $("#end_price").val((p + 1000) * (1 - d / 100));
                        $("#num").val(bussiness);
                    } else if (type == "经济舱") {
                        $("#price").val(p);
                        $("#end_price").val(p * (1 - d / 100));
                        $("#num").val(economy);
                    }
                });
            }
    ...
    function insertOrder() {
        ...
        // $.post("<%=basePath%>flight/insert.action",$("#edit_order_form").serialize(),function(data){
        $.ajax({
            type: "get",
            url: "<%=basePath%>flight/insert.action",
            data: $("#edit_order_form").serialize(),
            dateType: "json",
            success: function (result) {
                // var re=""+result
                // alert(result)
                // alert(eval(result) == "error")
                if (eval(result) == "error") {//转化成json才能比较正确返回true
                    alert("时间冲突，请重新选票");
                } else {
                    if ($("#tickect_type").val() == "经济舱" && economy == 0)
                        alert("经济舱无余票");
                    else if ($("#tickect_type").val() == "商务舱" && bussiness == 0)
                        alert("商务舱无余票");
                    else
                        alert("航班订单成功！");
                }
